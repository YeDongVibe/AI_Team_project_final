            ...
            <table className="border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border-2">
                    Remove plastic caps and different materials from the cans before disposal.
                  </td>
                </tr>
                <tr>
                  <td className="border-2">
            ...
            <table className="text-center border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border-2">
                    The components of the pump-type container (nozzle, spring, etc.) should be disposed of separately
                    and cleaned before disposal.
                  </td>
                </tr>
              </tbody>
            </table>
