...
export function GuideSection({currentSection}) {
  ...
  return (
    <section className="w-full h-screen bg-gradient-to-b from-[#EEFFE7] pt-[120px]">
      <div className="w-full pt-10 text-6xl font-bold text-right h-1/6 pr-14 font-Notable md:text-5xl sm:text-4xl md:h-12 sm:h-12">
        RECYLING TIP & GUIDE
      </div>
      <div className="flex w-full pt-10 h-1/2 md:flex-col md:items-center sm:items-center sm:flex-col">
        <div className="flex justify-center w-1/2">
          <img src={recyling_tip} className="p-10 pl-[150px] object-cover md:pl-[120px] sm:pl-[100px]" />
        </div>
        <div className="flex flex-col items-end justify-around w-1/2 pr-20 md:px-2 sm:px-2 md:flex-row sm:flex-row md:w-full sm:w-full">
          ...
          <Link to="/guide" className="w-40 btn rounded-2xl bg-[#B0E2C5] text-white md:w-24 sm:w-16">
            View More
      ...
      <div className="relative w-full mt-6 h-1/4 max-h-56">
        ...
        <p className="absolute text-4xl text-white font-poppins left-16 bottom-6 md:text-2xl sm:text-lg sm:bottom-0">
