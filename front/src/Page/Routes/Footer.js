  ...
  return (
    <footer className="px-24 w-full h-[231px]">
      <div className="w-full h-[150px] pl-8 bg-white">
        ...
        <p className="mt-2 text-base text-black">팀명 : 행복하조</p>
      </div>
      <div className="w-full h-[81px] flex border-y-2 border-[#BFBFBF] ">
        <p className="text-[13px] p-8 text-center text-[#4a4949]">이용약관</p>
