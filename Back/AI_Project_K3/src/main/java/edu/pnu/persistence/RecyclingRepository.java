...
public interface RecyclingRepository extends JpaRepository<Recycling, String> {
	...
	@Query("select r.detect_log_id, r.rm, r.ce, r.date, r.time, rr.category, rr.count"
			+ " from Recycling r "
	...
	@Query("select tr.detect_log_id, tr.rm, tr.ce, tr.date, tr.time, rl.category, rl.count"
			+ " from Recycling tr"
